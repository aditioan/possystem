...
include (APPPATH."libraries/Exceptions/BarcodeException.php");
include (APPPATH."libraries/Exceptions/InvalidCharacterException.php");
include (APPPATH."libraries/Exceptions/InvalidCheckDigitException.php");
include (APPPATH."libraries/Exceptions/InvalidFormatException.php");
include (APPPATH."libraries/Exceptions/InvalidLengthException.php");
include (APPPATH."libraries/Exceptions/UnknownTypeException.php");
...
class Barcode_library
{
    ...
    public function getBarcodeJPG($code, $type, $widthFactor = 2, $totalHeight = 30, $color = array(0, 0, 0))
    {
    ...
    public function getBarcodePNG($code, $type, $widthFactor = 2, $totalHeight = 30, $color = array(0, 0, 0))
    {
        $barcodeData = $this->getBarcodeData($code, $type);
