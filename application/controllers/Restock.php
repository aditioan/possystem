...
class Restock extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $data['restock'] = $this->penjualan_model->get_filter_tunggakan($filter);
    ...
    public function export_csv(){
        ...
        $data = $this->penjualan_model->get_filter_tunggakan($filter);
        $this->csv_library->export('restock_'.date("d-m-Y").'.csv',$data);
    }
}