            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="active"><a href="<?php echo site_url('pengiriman');?>">Pengiriman</a></li>
                    </ul>
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Log Data Pengiriman</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                ...
                                <?php if(isset($pengirimans) && is_array($pengirimans)){ ?>
                                    <?php foreach($pengirimans as $pengiriman){?>
                                        <tr>
                                            ...
                                            <td><?php echo $pengiriman->deleted_at;?></td>
                                            <td>
                                                <a onclick="return confirm('Apakah anda yakin akan mengembalikan data pengiriman ini?');" href="<?php echo site_url('log/pengiriman_return').'/'.$pengiriman->id_pengiriman;?>" class="btn btn-xs btn-warning">Pulihkan</a>
                                                <a onclick="return confirm('Apakah anda yakin akan menghapus secara total data pengiriman ini?');" href="<?php echo site_url('log/pengiriman_delete').'/'.$pengiriman->id_pengiriman;?>" class="btn btn-xs btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <?php } ?>
