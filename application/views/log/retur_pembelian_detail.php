            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="active"><a>Log Detail Retur Pembelian</a></li>
                    </ul>
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Data Retur Pembelian Detail <?php echo $details[0]->id_pretur;?></h3>
                            <div class="pull-right">
                                <span><a href="<?php echo site_url('log/retur_pembelian');?>" class="btn btn-sm btn-danger">Kembali</a></span>
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
