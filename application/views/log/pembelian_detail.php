            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul class="nav nav-tabs">
                        <li role="presentation" class="active"><a>Detail Log Pembelian</a></li>
                    </ul>
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Data Log Pembelian Detail <?php echo $details[0]->id_ptransaction;?></h3>
                            <div class="pull-right">
                                <span><a href="<?php echo site_url('log/pembelian');?>" class="btn btn-sm btn-danger">Kembali</a></span>
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
