...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('public');?>/css/jquery-jvectormap-1.2.2.css">
  ...
  <link href="<?php echo css_url('validation-engine.min.css'); ?>" rel="stylesheet" type="text/css" />
  <link href="<?php echo css_url('selectize.min.css'); ?>" rel="stylesheet" type="text/css" />
