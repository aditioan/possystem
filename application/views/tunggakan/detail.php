                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Data Tunggakan Detail <?php echo $details[0]->id_stransaction;?> <span class="bg-green"><?php echo $details[0]->is_cash == 1 ? "SUDAH LUNAS" : "";?></span></h3>
                            <div class="pull-right">
                                <span><a href="<?php echo site_url('tunggakan');?>" class="btn btn-sm btn-danger">Kembali</a></span>
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <?php if($details[0]->is_cash == 0){?>
                                <div class="text-center">
                                    <a href="<?php echo site_url('tunggakan/update_lunas').'/'.$details[0]->id_stransaction;?>" onclick="return confirm('Apakah anda yakin menandai ini sebagai lunas?');" class="btn btn-success">LUNAS</a>
                                </div>
                            <?php }?>
                        </div>
                        <!-- /.box-body -->
