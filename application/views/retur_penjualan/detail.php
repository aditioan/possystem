            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="active"><a>Detail Retur Penjualan</a></li>
                    </ul>
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Data Retur Penjualan Detail <?php echo $details[0]->id_sretur;?></h3>
                            <div class="pull-right">
                                <span><a href="<?php echo site_url('retur_penjualan');?>" class="btn btn-sm btn-danger">Kembali</a></span>
								<?php if($details[0]->is_return == 0){?>
                                <span><a href="<?php echo site_url('retur_penjualan/edit');?>/<?php echo $details[0]->id_sretur;?>" class="btn btn-sm btn-success">Edit</a></span>
								<?php } ?>
                            </div>
                        </div>
                        <!-- /.box-header -->
