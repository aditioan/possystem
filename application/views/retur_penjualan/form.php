      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="<?php echo site_url('retur_penjualan/create');?>"><?php echo !empty($edit)?'Ubah Retur Penjualan':'Tambah Retur Penjualan';?></a></li>
		  ...
		  <div class="box box-info">
            ...
            <form id="transaction-form" class="form-horizontal" method="POST" action="<?php echo site_url('retur_penjualan/update').'/'.$id_sretur;?>">
            <?php }else{?>
            ...
            <?php } ?>
              <div class="box-body">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="id" value="<?php echo !empty($id_sretur) ? $id_sretur : '';?>" class="form-control" disabled/>
                      <input type="hidden" name="retur_id" id="retur_id" value="<?php echo !empty($id_sretur) ? $id_sretur : '';?>"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-4 control-label" for="kode">Kode Penjualan TRX</label>
                     <div class="col-sm-8">
                       <input type="text" name="id" value="<?php echo !empty($id_stransaction) ? $id_stransaction : '';?>" class="form-control" disabled/>
                       <input type="hidden" name="retur_code" id="retur_code" value="<?php echo !empty($id_stransaction) ? $id_stransaction : '';?>"/>
                     </div>
                  </div>
                </div>
                <div class="col-md-6">
              ...
              <div class="box-footer">
                <div class="col-md-3 col-md-offset-4">
                  <a class="btn btn-default" href="<?php echo site_url('retur_penjualan/create');?>">Batal</a>
